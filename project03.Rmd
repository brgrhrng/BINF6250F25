...
def GibbsMotifFinder (seqs, k, seed=42):
    ...
    for iterations in range(0,10):
      ...
      #print(random_weights)
        ...
        new_motif_i = random.choices(range(0,len(seq)-k+1), relative_scores, k=1)
        print(new_motif_i)
