...
def read_fasta(filename: str) -> Dict[str, str]:
    ...
    establish empty dictionary for aa entries
    read line by line in for loop
    recognize new entry by ">" character 
    accession ID is in between "|" characters after "gi"
    isolate aa sequence by index of end of ID to new-line character?
    make ID: aa sequence as key-value pair
