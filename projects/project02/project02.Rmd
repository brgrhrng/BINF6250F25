...
def build_markov_model(markov_model, text, order=1):
    ...
    # Increment a counter for *S* -> word 0
    word_0 = list_of_words[0]
    markov_model["*S*"][word_0] = markov_model["*S*"].get(word_0,0) + 1
...
def generate_random_text(markov_model, seed=42):
    ...
    while(iters < 10000000):
        ...
        next_word = get_next_word(current_words, markov_model)
        ...
        # Append the next word to current_words string
...
try:
    with open("data/one_fish_two_fish.txt", "r") as file:
        ...
        markov_model = build_markov_model(markov_model, book_text, order=4)
