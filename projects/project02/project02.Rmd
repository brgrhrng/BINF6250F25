...
def build_markov_model(markov_model, text, order=1):
    ...
    #markov_model["*S*"][list_of_words[0]] = markov_model.get("*S*", dict()).get(list_of_words[0],0) + 1
    
    #if "*S*" in markov_model:
    #    markov_model["*S*"][list_] = markov
    #markov_model.get("*S*", dict())
    #markov_model["*S*"][list_of_words[0]]
    
    
    # The end marker can just be appended as an extra state.
