...
test_seq = "banana"
test_query = "ana"
test1 = FMIndex(test_seq)

print(f"SEQ: {test_seq}")
print(f"1st: {test1.get_reference_string()}")
print(f"BWT: {test1.bwt}")
print(f"suffix_i: {test1.suffix_indexes}")

print(f"\nQuery: {test_query}")
print(f"Locations: SEQ{test1.locate(test_query)}") # 1 3
```